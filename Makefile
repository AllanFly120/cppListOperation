...
#
#     gmake pa5list
#	 Makes pa5list executable.  (This is a test drive for your list functions)
#
#     gmake submit
...
pa5list: pa5list.cpp listFuncs.cpp listFuncs.h
	g++ -ggdb -Wall pa5list.cpp listFuncs.cpp -o pa5list
